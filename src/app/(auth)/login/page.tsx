...
export default function LoginPage() {
  return (
    <div className="w-full h-full flex flex-col lg:flex-row justify-center items-center shadow-md gap-4">
      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col items-center justify-center p-4">
        <p className="text-2xl font-bold text-primary">Best School System</p>
